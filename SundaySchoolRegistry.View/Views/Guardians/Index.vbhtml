@ModelType IEnumerable(Of SundaySchoolRegistry.Model.Guardian)
@Code
...
@For Each item In Model
    @<tr>
        ...
        <td>
            @Html.DisplayFor(Function(modelItem) item.CellNumber)
        </td>
        <td>
            @Html.DisplayFor(Function(modelItem) item.HomeNumber)
        </td>
